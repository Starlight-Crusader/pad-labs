...
from .views import UserSearchView, OpenFriendRequestView, FriendRequestListView, ReceivedFriendRequestsListView, ResolveFriendRequestView, FriendRequestDestroyView
...
urlpatterns = [
    ...
    path('requests/<int:pk>/destroy/', FriendRequestDestroyView.as_view(), name='user-destroy')
]